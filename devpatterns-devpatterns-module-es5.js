(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["devpatterns-devpatterns-module"], {
    ...
    function NG(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "DevpatternsModule", function () {
        return DevpatternsModule;
      });
      /* harmony import */
      ...
      var _devpatterns_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./devpatterns.component */
      "ObEA");
      /* harmony import */
      ...
      var appRoutes = [{
        path: '',
        component: _devpatterns_component__WEBPACK_IMPORTED_MODULE_3__["DevpatternsComponent"]
      }];

      var DevpatternsModule = function DevpatternsModule() {
        _classCallCheck(this, DevpatternsModule);
      };

      DevpatternsModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: DevpatternsModule
      });
      DevpatternsModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function DevpatternsModule_Factory(t) {
          return new (t || DevpatternsModule)();
        },
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](DevpatternsModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DevpatternsModule, [{
    ...
    function ObEA(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "DevpatternsComponent", function () {
        return DevpatternsComponent;
      });
      /* harmony import */
      ...
      var DevpatternsComponent = /*#__PURE__*/function () {
        function DevpatternsComponent() {
          _classCallCheck(this, DevpatternsComponent);
        }

        _createClass(DevpatternsComponent, [{
          key: "ngOnInit",
      ...
      DevpatternsComponent.ɵfac = function DevpatternsComponent_Factory(t) {
        return new (t || DevpatternsComponent)();
      };

      DevpatternsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: DevpatternsComponent,
        selectors: [["app-devpatterns"]],
        decls: 31,
        vars: 2,
        consts: [["role", "main", 1, "content"], [1, "with-icon"], [2, "color", "rgb(43, 75, 124)"], ["routerLink", "/auth/devprocscrum", 2, "text-decoration", "none", "color", "rgb(43, 75, 124)"], ["routerLink", "/auth/gitflow", 2, "text-decoration", "none", "color", "rgb(43, 75, 124)"], ["routerLink", "/auth/devopsmachine", 2, "text-decoration", "none", "color", "rgb(43, 75, 124)"]],
        template: function DevpatternsComponent_Template(rf, ctx) {
          if (rf & 1) {
        ...
        styles: ["mat-card[_ngcontent-%COMP%] {\n  padding: 5px;\n  margin: 5px;\n}\n\n.with-icon[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DevpatternsComponent, [{
...
//# sourceMappingURL=devpatterns-devpatterns-module-es5.js.map